        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text('Job_name'.tr,style: TextStyle(
                ...
                Text('workdays'.tr,style: TextStyle(
                  fontWeight: FontWeight.w500,
                  fontSize: 16.sp,
                  fontFamily: Const.appFont,
                  color: Color(0xff0565AC),
          ...
          Padding(
            padding: const EdgeInsetsDirectional.only(start: 14,end: 14,top: 15),
            child: Card(
              elevation: 3,
              child: Container(
                width: 343.w,
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text('جلوريا'.tr,style: TextStyle(
                        fontWeight: FontWeight.w500,
                        fontSize: 16.sp,
                        fontFamily: Const.appFont,
                      ...
                      Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Text('الأحد -الثلاثاء-الخميس '.tr,style: TextStyle(
                            fontWeight: FontWeight.w500,
                            fontSize: 14.sp,
                            fontFamily: Const.appFont,
                            color: Color(0xff000000),
                          ),),
                          Text('10:00-13:00'.tr,style: TextStyle(
                            fontWeight: FontWeight.w500,
                            fontSize: 16.sp,
                            fontFamily: Const.appFont,
